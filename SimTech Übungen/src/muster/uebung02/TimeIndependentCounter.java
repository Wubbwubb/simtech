 ...
 *
 * TimeIndependentCounter class Class just counts the given values without regarding the time the system remained in
 * this state.
 * 
...
public class TimeIndependentCounter extends Counter {
	...
	/**
	 * Method calculates and returns the mean of the observed variable without regarding the counting time
	 * 
	...
	/**
	 * Method calculates and returns the variance of the observed variable without regarding the counting time
	 * 
	...
	public double getVariance() {
		if (this.numSamples > 1) {
			...
			return this.numSamples / (double) (this.numSamples - 1) * (tmp2 - tmp1 * tmp1); // Equation 2.30
		}
		return 0;
	}

	/**
	 * Method counts the given argument by extending the "original" counting method.
	 * 
	 * @param x
