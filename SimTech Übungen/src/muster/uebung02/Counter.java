 ...
 *
 * Counter class Basic class for all counting objects
 * 
...
abstract class Counter {
	...
	/**
	 * Function calculates and returns the standard deviation by using the getVariance() function.
	 * 
	...
	/**
	 * Function calculates and returns the variation coefficient by using the getStdDeviation() and getMean() functions.
	 * 
	...
	/**
	 * Function only sets the min and the max counted value. Extending classes have to implement additional
	 * functionality. Hint: Time dependent counting differs from time independent counting
	 * 
	 * @param x
	 *            the value to count
	 */
	 ...
	 */
	public void report() {
		System.out.println("observed random variable: " + this.observedVariable);
		System.out.println("mean:                     " + this.getMean());
		System.out.println("variance:                 " + this.getVariance());
		System.out.println("standard deviation:       " + this.getStdDeviation());
		System.out.println("coefficient of variation: " + this.getCvar());
