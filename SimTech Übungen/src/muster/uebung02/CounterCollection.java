...
import muster.uebung01.SimParam;
import muster.uebung01.SystemState;
...
public class CounterCollection {
	 ...
	 */
	public static TimeIndependentCounter counter_waiting_time = new TimeIndependentCounter("waiting time per customer");
	/**
	 * Histogram - waiting time per customer
	 */
	public static TimeIndependentHistogram hist_waiting_time = new TimeIndependentHistogram(
			"waiting time per customer", "wtc.txt", 0, SimParam.buffersize * 1000, 10);
	/**
	 * Counter - queue length
	 */
	public static TimeDependentCounter counter_queuelength = new TimeDependentCounter("queue length");
	/**
	 * Histogram - queue length
	 */
	public static TimeDependentHistogram hist_queuelength = new TimeDependentHistogram("queue length", "ql.txt", 0,
			SimParam.buffersize, SimParam.buffersize + 1);
