 ...
 *
 * TimeDependentHistogram class Class representing a time dependent histogram
 * 
...
public class TimeDependentHistogram extends Histogram {
	 ...
	 *            number of bounds
	 */
	public TimeDependentHistogram(String oVariable, String fname, double lB, double uB, int num) {
