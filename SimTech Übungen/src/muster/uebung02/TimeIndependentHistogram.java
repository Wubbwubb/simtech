 ...
 * 
 * TimeDependentHistogram class Class representing a time independent histogram
 * 
...
public class TimeIndependentHistogram extends Histogram {
	 ...
	 *            number of bounds
	 */
	public TimeIndependentHistogram(String oVariable, String fname, double lB, double uB, int num) {
	...
	/**
	 * Function counts the given argument and sets the attributes according to the SimState
	 * 
	 * @param x
