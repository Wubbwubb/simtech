 ...
 *
 * Packet class 
 * Basic class containing information for a single packet
 * 
...
public class Packet {
	 ...
	 * @param t time of packet serving start
	 */
	 ...
	 * @param t time of packet serving completion
	 */
	...
	public void print()
	{
		...
		if (this.isServed)
		{
			System.out.println("Currently Served, arrived " + this.t_arrival
					+ ", serving start " + this.t_start_service);
		}
		if (this.isCompleted)
		{
			System.out.println("Completed, arrived " + this.t_arrival
					+ ", serving start " + this.t_start_service
